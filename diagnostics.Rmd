...
```{r}
qqnorm(resid(fit_1), main = "Normal Q-Q Plot, fit_1", col = "grey")
...
```{r}
qqnorm(resid(fit_2), main = "Normal Q-Q Plot, fit_2", col = "grey")
...
```{r}
qqnorm(resid(fit_3), main = "Normal Q-Q Plot, fit_3", col = "grey")
...
```{r}
qqnorm(resid(mpg_hp_add), col = "grey")
...
```{r}
qqnorm(resid(big_model), col = "grey")
