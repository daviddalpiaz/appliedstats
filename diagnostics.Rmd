...
```{r}
plot(y ~ x, data = sim_data_1, col = "dodgerblue", main = "Data from Model 1")
...
```{r}
plot(fitted(fit_1), resid(fit_1), col = "dodgerblue", 
...
plot(y ~ x, data = sim_data_2, col = "dodgerblue", main = "Data from Model 2")
...
```{r}
plot(fitted(fit_2), resid(fit_2), col = "dodgerblue", 
...
plot(y ~ x, data = sim_data_3, col = "dodgerblue", main = "Data from Model 3")
...
```{r}
plot(fitted(fit_3), resid(fit_3), col = "dodgerblue", 
...
```{r}
qqnorm(resid(fit_1), main = "Normal Q-Q Plot, fit_1", col = "dodgerblue")
...
```{r}
qqnorm(resid(fit_2), main = "Normal Q-Q Plot, fit_2", col = "dodgerblue")
...
```{r}
qqnorm(resid(fit_3), main = "Normal Q-Q Plot, fit_3", col = "dodgerblue")
qqline(resid(fit_3), col = "darkorange", lwd = 2)
```
