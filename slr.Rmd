...
That is $\beta_0 = 5$, $\beta_1 = 2$, and let $\epsilon \sim N(\mu = 0, \sigma^2 = 1)$. Or, even more succinctly we could write

$$
Y \mid X = x \sim N(\mu = 5 + 2 x, \sigma^ 2 = 1).
$$
...
```{r}
sim_data = sim_slr(x = x, beta_0 = 5, beta_1 = 2, sigma = 1)
```
