...
$$
Y \mid X \sim N(\mu = 5 - 2 x, \sigma^ 2 = 1).
$$
...
Now, since the $x_i$ values in SLR are considered fixed and known, we simply generate them from a uniform distribution, and then use them for the remainder of the analysis. Know that this is an arbitrary, but common practice. We could have also specified 20 specific values of our choice.
