...
- State the end goal you are trying to acheive. (Sometimes what you expect the code to do, is not what you want to actually do.)
...
TODO: function and arguemnts, etc. where to put?
