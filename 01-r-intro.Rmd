...
One of the biggest strengths of `R` its ability to carry out simulations. We'll look at two examples here, but simulation will be a topic we revisit several times throughout the course.
...
For another example of simulation, we will simulate observations from a Poisson distribution, and examine the empirical distribution of these observations.
