...
What happens when we fit a regression model in `R` using all of the predictors?
...
When this happens, we say there is exact collinearity. 
...
Exact collinearity is an extreme example of multicollinearity, which occurs in multiple regression when predictor variables are highly correlated.
...
- TODO: insert usual equation
- TODO: change Sxx notation
...
- TODO: exp vs prediction

```{r}
plot(predict(fit), predict(fitNoise))
```
...
- TODO: Beware of overfitting? Over save for selection?

### Bodyfat Example

- TODO: Move this to different document. Split data into `.csv`
...
TODO: add numeric means and variances
...
TODO: DONT USE VIF AS VARIABLE SELECTION, REMOVING HIGHEST IS BAD!!!!!!!!!!!!!!!!