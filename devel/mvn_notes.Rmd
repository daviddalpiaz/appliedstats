...
$$\Sigma  = {\left[ {\begin{array}{*{20}{c}}
  {{\bf{\Sigma}_{11}}}&{{\bf{\Sigma}_{12}}}& \cdots &{{\bf{\Sigma}_{1n}}} \\ 
  {{\bf{\Sigma}_{21}}}&{{\bf{\Sigma}_{22}}}&{}&{{\bf{\Sigma}_{2n}}} \\ 
   \vdots &{}& \ddots & \vdots  \\ 
  {{\bf{\Sigma}_{n1}}}&{{\bf{\Sigma}_{n2}}}& \cdots &{{\bf{\Sigma}_{nn}}} 
...
\end{array}} \right]_{n \times n}} = {\left[ {\begin{array}{*{20}{c}}
  {{\bf{\Sigma}_{11}}}&{{\bf{\Sigma}_{12}}}& \cdots &{{\bf{\Sigma}_{1n}}} \\ 
  {{\bf{\Sigma}_{12}}}&{{\bf{\Sigma}_{22}}}&{}&{{\bf{\Sigma}_{2n}}} \\ 
   \vdots &{}& \ddots & \vdots  \\ 
  {{\bf{\Sigma}_{1n}}}&{{\bf{\Sigma}_{2n}}}& \cdots &{{\bf{\Sigma}_{nn}}} 
\end{array}} \right]_{n \times n}}$$
