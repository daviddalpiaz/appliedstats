...
TODO: note Y and X random, $(x_i, y_i)$ are observed data.
...
TODO: this is where we should discuss the difference between random and not. Y vs Y_i
...
This probably seems like a natural estimate, aside from the use of $n - 2$, which we will put of until next chapter. (We will also define another estimate later in this chapter that uses $n$ instead.) It should actually look rather familiar.
